...
RUN --mount=type=cache,id=s/690fbfdb-f377-4bed-a83b-003ef673582b-/root/.cache/uv,target=/root/.cache/uv \
...
RUN --mount=type=cache,id=s/690fbfdb-f377-4bed-a83b-003ef673582b-/root/.npm,target=/root/.npm \
    npm ci
