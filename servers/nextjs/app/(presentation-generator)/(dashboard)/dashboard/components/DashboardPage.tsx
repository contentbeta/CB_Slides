    ...
    <div className="min-h-screen w-full px-3 pb-10 sm:px-6 relative">
      ...
      <section className="relative z-10 overflow-visible  ">
        ...
        <Link
          ...
          className="group/action bg-white z-50 mt-2  relative  block w-[304px] max-w-full overflow-visible rounded-[10.8px] outline-none focus-visible:ring-2 focus-visible:ring-[#9748b1] focus-visible:ring-offset-4 cursor-pointer"
      ...
      <section className="relative z-10 mt-12">
        <div className="mb-4 flex items-center justify-between">
          ...
          <button
            type="button"
            className="flex h-8 w-8 items-center justify-center rounded-full text-[#2F3033] transition-colors hover:bg-[#F3F3F6] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#9748b1]"
