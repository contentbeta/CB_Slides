...
const LayoutItem = memo(({ layout, onSelect }: LayoutItemProps) => {
  ...
  return (
    <div
      ...
      className="relative aspect-video cursor-pointer overflow-hidden rounded-md border border-[#E4E4EA] bg-white shadow-[0_1px_2px_rgba(16,24,40,0.04)] outline-none transition duration-200 hover:border-[#c25de2] hover:shadow-[0_0_0_2px_rgba(124,81,248,0.18)] focus-visible:ring-2 focus-visible:ring-[#c25de2]"
    >
  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-[64px] items-center justify-between border-b border-[#EDEEEF] px-5 py-4 md:px-6">
        ...
        {loading && (
          <Loader2 className="h-5 w-5 animate-spin text-[#c25de2]" />
        )}
      </div>
      ...
      <div className="max-h-[min(70vh,640px)] overflow-y-auto px-4 py-4 md:px-5">
        {loading ? (
          <div className="flex h-56 items-center justify-center">
            <Loader2 className="h-8 w-8 animate-spin text-[#c25de2]" />
          </div>
        ) : layouts.length > 0 ? (
