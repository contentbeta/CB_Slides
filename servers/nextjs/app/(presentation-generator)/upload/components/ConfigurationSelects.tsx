        ...
        <Popover open={open} onOpenChange={onOpenChange}>
            <PopoverTrigger asChild>
                <button
                    ...
                    aria-expanded={open}
                    className=" overflow-hidden font-syne font-medium  text-[#191919]  focus-visible:ring-[#c35de4]/30 flex justify-between items-center gap-2 h-[34px] rounded-full px-3.5 ring-1 ring-inset ring-slate-200 shadow-sm"
                >
