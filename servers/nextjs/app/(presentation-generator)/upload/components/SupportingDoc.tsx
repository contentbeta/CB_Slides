...
const SupportingDoc = ({
    ...
    return (
        <div className="space-y-2" data-testid="attachments-uploader">
            ...
            <label
                className={`mt-1 block cursor-pointer rounded-lg border-2 border-dashed px-4 py-6 text-center transition-colors ${isDragging ? 'border-[#c35de4] bg-[#c35de4]/5' : 'border-gray-200 hover:border-[#c35de4]'}`}
