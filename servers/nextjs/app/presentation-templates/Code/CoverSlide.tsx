...
export const Schema = z.object({
  companyName: z
    ...
    .meta({
      description:
        "Optional organization/institution/presenter name shown above the slide title.",
    }),
    ...
    <>
      ...
      >
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-[200px] text-center">
          <p
            className="text-[22px]"
            style={{ color: "var(--background-text,#d7dcff)" }}
          >
            {data.companyName}
          </p>
          <h2
            className="mt-[10px] text-[64px] font-medium"
            style={{ color: "var(--background-text,#ffffff)" }}
          >
            {data.title}
          </h2>
          <p
            className="mt-[35px] text-[26px] leading-[132%]"
            style={{ color: "var(--background-text,#d8ddff)" }}
          >
            {data.subtitle}
          </p>
        </div>
