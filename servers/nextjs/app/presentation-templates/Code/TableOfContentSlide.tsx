    ...
    .array(
      z.object({
        number: z
          ...
          .min(2)
          .max(2)
          .meta({ description: "Bullet Serial Number" }),
        label: z
          .string()
          .min(3)
          .max(30)
          .meta({ description: "Page/Content Name" }),
        description: z
          .string()
          .min(3)
          .max(100)
          .optional()
          .meta({ description: "Short description for the content section." }),
      }),
    )
    .min(12)
    .max(12)
        ...
        return (
          ...
          >
            <div className="flex items-center gap-[10px]">
              ...
              <p
                className="w-[36px] text-[18px] leading-none"
                style={{ color: "var(--primary-text,#8EC5FF)" }}
              >
                {item.number}
              </p>
            </div>
