...
export const Schema = z.object({
  ...
  topPanelText: z
    ...
    .min(20)
    .max(70)
    .default("Insert info about the company.")
    .meta({
  ...
  bottomPanelText: z
    ...
    .min(20)
    .max(70)
    .default("Insert info about the company and your mission statement.")
    .meta({
      ...
      >
        <div className="grid  items-end grid-cols-[1fr_1fr]">
          <div className="px-[53px] pb-[56px] ">
            ...
            <p
              className="mt-[30px] max-w-[610px] text-[22px] font-semibold leading-[1.24]"
              style={{ color: "var(--background-text,#34394C)" }}
            >
              {data.intro}
            </p>
            <p
              className="mt-[18px] max-w-[620px] text-[22px] leading-[1.28]"
              style={{ color: "var(--background-text,#46474C)" }}
            >
              {data.body}
            </p>
          </div>
          ...
          <div className=" ">
            <div className="relative flex  overflow-hidden  h-[360px]">
              ...
              <div className="w-1/2 z-10 flex justify-center items-center relative">
                ...
                />
                <p
                  className="relative z-10 text-[24px] leading-[1.22] px-[42px]"
                  style={{ color: "var(--primary-text,#f5f7ff)" }}
                >
                  {data.topPanelText}
                </p>
              </div>
