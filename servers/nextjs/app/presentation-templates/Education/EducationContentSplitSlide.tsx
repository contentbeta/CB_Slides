...
export const Schema = z.object({
  ...
  images: z
    ...
    .meta({
      description:
        "Array of images reused to create the left collage composition.",
    }),
});

export type SchemaType = z.infer<typeof Schema>;

const EducationContentSplitSlide = ({
  data,
}: {
      ...
      >
        <div className="w-full flex items-center h-full">
          ...
          <div className="w-1/2 px-[56px]">
            ...
            <p
              className=" text-[14px] font-medium mt-1 leading-none tracking-[0.04em]"
              style={{ color: "var(--background-text,#454962)" }}
            >
              {tagline}
            </p>
            <p
              className="mt-[18px] text-[22px] leading-[1.28]"
              style={{ color: "var(--background-text,#34394C)" }}
            >
              {body}
            </p>
