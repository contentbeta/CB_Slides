...
const EducationServicesSplitSlide = ({
  data,
}: {
        ...
        <div className="grid h-full grid-cols-[365px_1fr]">
          ...
          >
            {sections?.map((section, index) => (
              ...
              >
                <div
                  className=" min-w-[316px] max-w-[316px] "
                  style={{
                    height:
                      sections?.length === 4
                        ? "175px"
                ...
                <div className={`px-[56px] `}>
                  ...
                  <p
                    className="mt-[10px] text-[14px] font-medium uppercase leading-none"
                    style={{ color: "var(--background-text,#454962)" }}
                  >
                    {section.tagline}
                  </p>
                  <p
                    className="mt-[18px]  text-[22px] leading-[1.26] tracking-[0.04em]"
                    style={{ color: "var(--background-text,#34394C)" }}
                  >
                    {section.body}
                  </p>
