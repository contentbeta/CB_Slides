...
function TimelineUpToSix({ milestones }: { milestones: any }) {
  return (
        ...
        {milestones.map((milestone: any, index: number) => (
          <div key={`${milestone.heading}-${index}`} className="">
            <div className="flex items-center ">
              <div
                className="h-[22px] z-10 relative w-[22px] rounded-full"
...
function TimelineMoreThanSix({
  ...
  return (
    <div className="relative z-10 mt-[84px] px-[56px]">
      ...
      <svg
        className="absolute z-[-1] right-[100px] top-[10px]"
      ...
      >
        ...
        <path
          d="M0 -2.66667H128C135.364 -2.66667 141.333 3.30287 141.333 10.6667H136C136 6.24839 132.418 2.66667 128 2.66667H0V-2.66667ZM141.333 220C141.333 227.364 135.364 233.333 128 233.333H0V228H128C132.418 228 136 224.418 136 220H141.333ZM136 220M0 230.667V0V230.667M128 -2.66667C135.364 -2.66667 141.333 3.30287 141.333 10.6667V220C141.333 227.364 135.364 233.333 128 233.333V228C132.418 228 136 224.418 136 220V10.6667C136 6.24839 132.418 2.66667 128 2.66667V-2.66667Z"
          fill="var(--primary-color,#101C3D)"
          fillOpacity="0.1"
          mask="url(#path-1-inside-1_220_636)"
        />
      </svg>
          ...
          return (
            ...
            >
              ...
              <div className="pl-2 mt-[18px]">
                ...
                <p
                  className="mt-2 text-[18px] text-right leading-[1.2]"
                  style={{ color: "var(--background-text,#3a3d4c)" }}
                >
                  {item.description}
                </p>
