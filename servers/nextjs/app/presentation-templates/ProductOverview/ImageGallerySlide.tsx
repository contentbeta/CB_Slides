  ...
  topCenterImage: z
    .object({
      ...
      __image_prompt__: z
        .string()
        .max(80)
        .default("Design team discussing project board"),
    })
    .default({
      __image_url__:
        "https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&w=800&q=80",
  ...
  topRightImage: z
    .object({
      ...
      __image_prompt__: z
        .string()
        .max(80)
        .default("Creative desk with notebook and photos"),
    })
    .default({
      __image_url__:
        "https://images.unsplash.com/photo-1455390582262-044cdead277a?auto=format&fit=crop&w=800&q=80",
  ...
  bottomWideImage: z
    .object({
      ...
      __image_prompt__: z
        .string()
        .max(80)
        .default("City skyline seen from office window"),
    })
    .default({
      __image_url__:
        "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?auto=format&fit=crop&w=1300&q=80",
  ...
  bottomCenterImage: z
    .object({
      ...
      __image_prompt__: z
        .string()
        .max(80)
        .default("Art gallery wall with framed photos"),
    })
    .default({
      __image_url__:
        "https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&w=900&q=80",
  ...
  bottomRightImage: z
    .object({
      ...
      __image_prompt__: z
        .string()
        .max(80)
        .default("Office workshop with presentation board"),
    })
    .default({
      __image_url__:
        "https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=900&q=80",
