...
export const Schema = z.object({
  ...
  summaryCards: z
    ...
    .meta({
      description:
        "Four compact summary cards displayed above the dashboard panels.",
    }),
  charts: z
    ...
    <>
      ...
      >
        ...
        {summaryCards && summaryCards.length > 0 && (
          <div
            className=" mx-[64px] grid bg-white gap-[16px] p-[13px] mt-[22px] rounded-[14px]  "
            style={{
        ...
        <div className="flex-1 min-h-0 flex flex-col overflow-hidden pb-[30px]">
          {halfChart && halfChart.length > 0 && (
            <div
              className="mt-[14px] min-h-0 px-[64px] flex-1 overflow-hidden"
              style={{
                height:
          ...
          {otherHalfChart && otherHalfChart.length > 0 && (
            <div className="mt-[14px] min-h-0 px-[64px] flex-1 h-[200px] overflow-hidden">
              <div
                className={`grid h-full min-h-0 overflow-hidden bg-white p-[13px] rounded-[14px] gap-[10px] `}
                style={{
