...
const MemberSchema = z.object({
  ...
  image: z
    .object({
      ...
      __image_prompt__: z
        .string()
        .default("Professional portrait of a team member"),
    })
    .default({
      __image_url__:
        "https://presenton-public.s3.ap-southeast-1.amazonaws.com/static/images/placeholder.jpg",
...
export const Schema = z.object({
  members: z
    ...
    .meta({
      description:
        "List of team members shown as portrait cards. Each member contains a title, subtext, and image.",
    }),
});
    ...
    <>
      ...
      >
        <div
          ...
          style={{
            gridTemplateColumns: `repeat(${data?.members?.length}, minmax(0, 1fr))`,
          }}
        >
          {data?.members?.map((member, index) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(to top, var(--graph-1,#4d4ef3), rgba(77, 78, 243, 0.55), transparent)",
                }}
              />
              <div
                className="absolute left-0 bottom-0 p-[33px]  text-white"
              ...
              >
                ...
                <p className="mt-[14px] text-[28px] ">{member.subtext}</p>
              </div>
            </div>
          ))}
        </div>
