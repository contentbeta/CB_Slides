...
export const Schema = z.object({
  ...
  position: z
    ...
    .min(1)
    .max(20)
    .default("Company Name | Strategy, Content, growth")
    .meta({
      description:
        "Position or role of the presenter or address of the company/organization.",
    }),
});
  ...
  return (
    <>
      ...
      >
        ...
        >
          <path
            d="M0 0H44.6667V228.333C44.6667 240.668 34.6677 250.667 22.3333 250.667C9.99898 250.667 0 240.668 0 228.333V0Z"
            fill="var(--primary-color,#147CFE)"
          />
          <path
            d="M71.3334 0H116V163C116 175.334 106.001 185.333 93.6667 185.333C81.3324 185.333 71.3334 175.334 71.3334 163V0Z"
            fill="var(--primary-color,#147CFE)"
          />
        </svg>
        <svg
          className="absolute bottom-0 right-10 rotate-180"
          xmlns="http://www.w3.org/2000/svg"
          width="116"
          height="251"
          viewBox="0 0 116 251"
        ...
        <div className="text-center">
          <h4
            className="text-[#232223] text-[40px]  pb-4"
            style={{ color: "var(--background-text,#232223)" }}
          >
            {name}
          </h4>
          <p
            className="text-[19px] text-[#232223]"
            style={{ color: "var(--background-text,#232223)" }}
          >
            {position}
          </p>
