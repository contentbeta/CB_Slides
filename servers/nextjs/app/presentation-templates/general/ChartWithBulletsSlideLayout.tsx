...
export const layoutDescription =
  "A slide layout with title, description, chart on the left and colored bullet boxes with icons on the right. Only choose this if data is available.";
...
const chartWithBulletsSlideSchema = z.object({
  ...
  chartData: z
    .union([barPieLineAreaChartDataSchema, scatterChartDataSchema])
    .default({
      type: "bar",
      data: [
        { name: "Q1", value: 5 },
      ...
      >
        ...
        <div className="flex h-full px-8 sm:px-12 lg:px-20 pt-8 pb-8">
          ...
          <div className="flex-1 flex flex-col pr-8">
            ...
            {/* Chart Container */}
            <div
              className="flex-1 min-h-0 overflow-hidden rounded-lg shadow-sm border border-gray-100 p-4"
              style={{
          ...
          <div className="flex-shrink-0 w-80 flex flex-col justify-center space-y-4">
            {bulletPoints.map((bullet, index) => (
              <div
                ...
                style={{
                  backgroundColor: "var(--primary-color,#8b42a3)",
                }}
              >
                {/* Icon and Title */}
