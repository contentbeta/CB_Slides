      ...
      >
        ...
        <div className="relative z-10 flex h-full px-8 sm:px-12 lg:px-20 pt-12 pb-8">
          ...
          <div className="flex-1 flex flex-col justify-center pl-8 space-y-6">
            ...
            {/* Purple accent line */}
            <div
              style={{ background: "var(--background-text,#8b42a3)" }}
            ...
            {/* Presenter Section */}
            <div
              className="bg-white/50 backdrop-blur-sm rounded-lg p-4 lg:p-6 border border-gray-200 shadow-sm"
              style={{
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div
                  ...
                  className="w-10 h-10 lg:w-12 lg:h-12 bg-purple-600 rounded-full flex items-center justify-center"
                >
                  <span
