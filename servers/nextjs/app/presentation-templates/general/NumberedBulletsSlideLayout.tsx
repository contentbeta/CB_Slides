...
export const layoutDescription =
  "A slide layout with large title, supporting image, and numbered bullet points with descriptions.";
    ...
    .default([
      {
        ...
        description:
          "Surveys reveal that 78% of businesses are planning to invest in digital solutions, with 85% preferring customized approaches.",
      },
      {
        title: "Pilot Program Success",
        description:
          "The survey revealed that 78% of businesses plan to invest in digital solutions, and 85% prefer a tailored approach.",
      },
      {
        title: "Pilot Program Success",
        description:
...
export type NumberedBulletsSlideData = z.infer<
  typeof numberedBulletsSlideSchema
>;
...
const NumberedBulletsSlideLayout: React.FC<NumberedBulletsSlideLayoutProps> = ({
  data: slideData,
}) => {
          ...
          <div className="flex items-start justify-between mb-8">
            ...
            <div className="flex-1 pr-8">
              ...
              <div
                ...
                className="w-24 h-1 bg-purple-600 mb-6"
              ></div>
            </div>
            ...
            <div className="flex-shrink-0 w-80 h-48">
              <img
                ...
                alt={
                  slideData?.image?.__image_prompt__ || slideData?.title || ""
                }
            ...
            >
              ...
              <defs>
                <linearGradient
                  ...
                  y2="0%"
                >
                  <stop offset="0%" stopColor="var(--primary-color,#8b42a3)" />
                  <stop offset="50%" stopColor="var(--primary-color,#8b42a3)" />
                  <stop
                    offset="100%"
                    stopColor="var(--primary-color,#8b42a3)"
                  />
                </linearGradient>
              </defs>
            </svg>
