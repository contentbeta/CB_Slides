...
export const layoutDescription = "An image list with description slide layout";
...
const ImageListWithDescriptionSlideLayout: React.FC<
  ImageListWithDescriptionSlideLayoutProps
> = ({ data: slideData }) => {
      ...
      >
        ...
        <div className="flex h-full px-16 pb-16">
          ...
          <div className="absolute top-20 left-16 right-16">
            <h1
              className="text-5xl font-bold leading-tight text-left"
