    ...
    .default([
      {
        ...
        icon: {
          __icon_url__:
            "https://presenton-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/code-bold.svg",
      ...
      },
      {
        ...
        icon: {
          __icon_url__:
            "https://presenton-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/headphones-bold.svg",
...
export type BulletIconsOnlySlideData = z.infer<
  typeof bulletIconsOnlySlideSchema
>;
...
const BulletIconsOnlySlideLayout: React.FC<BulletIconsOnlySlideLayoutProps> = ({
  data: slideData,
}) => {
      ...
      >
        ...
        <div className="relative z-10 flex h-full px-8 sm:px-12 lg:px-20 pt-12 pb-8">
          ...
          <div className="flex-1 flex flex-col pr-8">
            ...
            <h1
              style={{ color: "var(--background-text,#111827)" }}
              className="text-[42.7px] font-bold text-gray-900 mb-8"
            >
            ...
            {/* Bullet Points Grid */}
            <div
              className={`grid ${getGridClasses(bulletPoints.length)} flex-1 content-center`}
            >
          ...
          <div className="flex-shrink-0 w-96 flex items-center justify-center relative">
            ...
            <div
              ...
              className="absolute top-8 right-8 text-purple-600 opacity-60"
            >
              <svg
                width="32"
                height="32"
