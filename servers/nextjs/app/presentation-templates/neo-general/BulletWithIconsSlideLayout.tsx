...
const bulletWithIconsSlideSchema = z.object({
  ...
  image: ImageSchema.default({
    ...
    __image_prompt__:
      "Business people analyzing documents and charts in office",
  }).meta({
          ...
          <div className="flex flex-1">
            ...
            <div className="flex-1 relative">
                  ...
                  <defs>
                    ...
                    >
                      <path
                        d="M 20 0 L 0 0 0 20"
                        fill="none"
                        stroke="var(--primary-color,#8b42a3)"
                        strokeWidth="0.5"
                      />
                    </pattern>
                  </defs>
              ...
              <div
                ...
                className="absolute top-20 right-8 text-purple-600"
              >
                <svg
                  width="24"
                  height="24"
                ...
                {bulletPoints.map((bullet, index) => (
                  <div key={index} className="flex items-start space-x-4">
                    ...
                    <div
                      ...
                      className="flex-shrink-0 w-12 h-12 rounded-lg shadow-md flex items-center justify-center"
                    >
                      <RemoteSvgIcon
                    ...
                    <div className="flex-1">
                      ...
                      <div
                        style={{ background: "var(--primary-color,#8b42a3)" }}
                        className="w-12 h-0.5 bg-purple-600 mb-3"
                      ></div>
                      <p
                        style={{ color: "var(--background-text,#4b5563)" }}
