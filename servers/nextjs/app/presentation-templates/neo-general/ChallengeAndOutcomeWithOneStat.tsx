...
export const Schema = z.object({
  title: z
    ...
    .default("Customer Proof / Case Snapshot"),
  challengeSectionTitle: z
    .string()
    .max(12)
    .describe("Heading for the first content section")
    .default("CHALLENGE"),
  challengeContent: z
    .string()
    .max(140)
    .describe("Descriptive text for the first section")
    .default(
  ...
  outcomeSectionTitle: z
    .string()
    .max(12)
    .describe("Heading for the second content section")
    .default("OUTCOME"),
  outcomePoints: z
    .array(z.string().max(40))
    .min(1)
    .max(5)
    .describe("List of bullet points for the second section")
    .default([
  ...
  customerName: z
    .string()
    .max(15)
    .describe("Primary name or title in the card")
    .default("TechCorp Global"),
  customerSubTitle: z
    .string()
    .max(26)
    .describe("Subtitle or secondary text in the card")
    .default("Fortune 500 Technology Company"),
  metricValue: z
    .string()
    .max(6)
    .describe("The primary metric or statistic value")
    .default("$4.2M"),
  metricLabel: z
    .string()
    .max(26)
    .describe("Label describing the metric")
    .default("incremental pipeline in Q4"),
  metricIcon: z
    .object({
      __icon_url__: z.string(),
      __icon_query__: z.string().max(30),
    })
    .describe("Icon displayed with the metric")
    .default({
      __icon_url__:
...
const dynamicSlideLayout: React.FC<{ data: Partial<FormData> }> = ({
  ...
  return (
    <>
      ...
      <div
        className="relative w-full h-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-[#FFFFFE] z-20 mx-auto overflow-hidden flex flex-col p-[60px]"
        style={{
      ...
      >
        ...
        <div className="mb-8">
          <h1
            className="text-[42.7px]  text-[#101828]  font-bold leading-[56px] tracking-[-2px] mb-4"
            style={{ color: "var(--background-text, #111827)" }}
          >
            {title}
          </h1>
          <div
            ...
            style={{ background: "var(--primary-color, #c25de2)" }}
          />
        </div>
        {/* Main Content Area */}
        <div className="flex w-full h-full gap-10">
          ...
          <div className="flex-[1.2] flex flex-col">
            ...
            <div className=" mb-5">
              <h2
                className="text-[21.3px]   font-normal mb-2 uppercase tracking-wide"
                style={{
              ...
              <p
                className="text-[23.1px]  font-normal leading-[32.3px]"
                style={{
            ...
            <div>
              ...
              <div className="flex flex-col gap-1">
                {outcomePoints?.map((point, index) => (
                  <div
                    key={index}
                    className="flex text-[23.1px]   font-normal leading-[32.3px]"
                    style={{
                      color: "var(--background-text,#000000)",
                    }}
                  >
          ...
          <div className="flex-1 flex items-center justify-center">
            <div
              className=" p-10 rounded-xl flex flex-col items-start min-w-[420px]"
              style={{
            ...
            >
              ...
              <div className="mb-10">
                <h3
                  className="text-[28.7px]   font-bold leading-[40.2px]"
                  style={{
                    color: "var(--background-text,#000000)",
                  }}
                >
                ...
                <p
                  className="text-[14.9px]   font-normal"
                  style={{
                    color: "var(--background-text,#000000)",
                  }}
                >
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col">
                  <span
                    className="text-[70.1px] text-[#4D5463]  font-normal leading-[78.7px]"
                    style={{
                  ...
                  <span
                    className="text-[17.4px] text-[#4D5463]  font-normal leading-[22px] max-w-[180px]"
                    style={{
                      color: "var(--background-text,#4D5463)",
                    }}
                  >
