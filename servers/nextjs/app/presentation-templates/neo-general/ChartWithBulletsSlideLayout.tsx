    ...
    .default([
      {
        ...
        description:
          "Companies can use TAM to plan future expansion and investment.",
        icon: {
          __icon_url__:
      ...
      },
      {
        ...
        description:
          "Indicates more measurable market segments for sales efforts.",
        icon: {
          __icon_url__:
            "https://presenton-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/chart-line-up-bold.svg",
      ...
      },
      {
        ...
        description:
          "Help companies plan development strategies according to the market.",
        icon: {
          __icon_url__:
            "https://presenton-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/chart-line-up-bold.svg",
...
export type ChartWithBulletsSlideData = z.infer<
  typeof chartWithBulletsSlideSchema
>;
...
const ChartWithBulletsSlideLayout: React.FC<
  ChartWithBulletsSlideLayoutProps
> = ({ data: slideData }) => {
  ...
  const divergingLabels = slideData?.chartData?.divergingLabels || [
    "Positive",
    "Negative",
  ];
    ...
    const renderPieLabel = (props: any) => {
      ...
      return (
        <text
          ...
          fill="var(--text-body-color,#4b5563)"
          fontSize={10}
        >
          ...
          >
            ...
            {series.map((s: string, index: number) => (
              <Bar
                ...
                fill={graphColors(index)}
                radius={[3, 3, 0, 0]}
                barSize={Math.max(15, 50 / series.length)}
              />
            ))}
          </BarChart>
        );
      ...
      >
        ...
        <div className="flex h-full px-8 sm:px-12 lg:px-20 pt-8 pb-8">
          ...
          <div className="flex-1 flex flex-col pr-8">
            ...
            <h1
              style={{ color: "var(--background-text,#111827)" }}
              className="text-[42.7px] font-bold text-gray-900 mb-4"
            >
            ...
            {/* Chart Container */}
            <div
              className="flex-1 min-h-0 overflow-hidden rounded-lg shadow-sm border  p-2 max-h-[460px]"
              style={{
          ...
          <div className="flex-shrink-0 w-80 flex flex-col justify-center space-y-4">
            {bulletPoints.map((bullet, index) => (
              <div
                ...
                style={{
                  backgroundColor: "var(--card-color,#8b42a3)",
                }}
              >
                {/* Icon and Title */}
