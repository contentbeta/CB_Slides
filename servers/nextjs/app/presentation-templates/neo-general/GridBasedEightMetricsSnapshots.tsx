...
export const Schema = z.object({
  title: z
    ...
    .default("Campaign Performance Snapshot"),
  ...
  cards: z
    .array(
      z.object({
        metric: z
          .string()
          .describe("Primary value or statistic displayed")
          .max(20),
        label: z.string().describe("Title or name of the card item").max(30),
        subtext: z
          .string()
          .describe("Secondary text or additional data")
          .max(30),
        isHighlighted: z
          .boolean()
    ...
    .max(8)
    .min(3)
    .describe("Array of metric cards for the grid")
    .default([
      {
        metric: "342 SQLs",
        label: "Enterprise ABM Launch",
        subtext: "28% CONVERSION RATE",
        isHighlighted: false,
      },
      {
        metric: "$1.8M pipeline",
        label: "Product Feature Release",
        subtext: "4.7X ROAS",
        isHighlighted: false,
      },
      {
        metric: "156 Deals",
        label: "Industry Summit Sponsorship",
        subtext: "42% MEETING RATE",
        isHighlighted: true,
      },
      {
        metric: "156 Deals",
...
const dynamicSlideLayout: React.FC<{
  ...
  return (
    <>
      ...
      />
      <div
        className="relative w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video    mx-auto overflow-hidden font-['Poppins'] flex flex-col items-center justify-center font-bold  px-[64px] py-[40px]"
        style={{
