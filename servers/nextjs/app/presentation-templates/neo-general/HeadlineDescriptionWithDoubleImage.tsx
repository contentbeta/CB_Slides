...
export const Schema = z.object({
  ...
  firstImage: z
    ...
    .default({
      ...
      __image_prompt__:
        "A close-up image of a professional team joining hands in a circle, symbolizing unity and partnership.",
    }),
  secondImage: z
    .object({
      __image_url__: z.string(),
 ...
 */
const HeadlineDescriptionWithDoubleImageLayout = ({
  data,
}: {
      ...
      >
        ...
        <div className="flex flex-1 w-full h-full px-[89.6px] py-[60px]">
          ...
          <div className="flex flex-col flex-[1.2] justify-center items-start">
            {/* Title */}
            <h1
              className="text-[42.7px]  text-[#101828]  font-bold leading-[1.1] tracking-[-2px] mb-4"
              style={{
            ...
            <div
              className="w-[116.6px] h-[5.7px] bg-[#c25de2] mb-8"
              style={{
            ...
            {/* Description */}
            <p
              className="text-[16.0px] text-[#000000] font-['Poppins'] font-normal leading-[1.8] max-w-[510px]"
              style={{
