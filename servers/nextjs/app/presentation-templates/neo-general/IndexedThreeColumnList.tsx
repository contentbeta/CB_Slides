...
export const Schema = z.object({
  title: z
    ...
    .default("Target Audience Breakdown"),
  columns: z
    .array(
      z.object({
        index: z
          .string()
          .max(2)
          .describe("Display number or index for the column")
          .default("01"),
        heading: z
          .string()
          .max(20)
          .describe("Primary heading of the column")
          .default("C-Suite Executives"),
        labelOne: z
          .string()
          .max(12)
          .describe("Label for the first content block")
          .default("KEY NEED"),
        contentOne: z
          .string()
          .max(50)
          .describe("Content for the first block")
          .default("Strategic growth & competitive advantage"),
        labelTwo: z
          .string()
          .max(12)
          .describe("Label for the second content block")
          .default("PRIMARY CHANNEL"),
        contentTwo: z
          .string()
          .max(50)
          .describe("Content for the second block")
          .default("LinkedIn, executive events"),
      }),
    )
    .max(3)
    .describe("Array of columns with indexed content")
    .default([
      {
        index: "01",
...
const dynamicSlideLayout: React.FC<{ data: Partial<DataType> }> = ({
  data,
}) => {
  ...
  return (
    <>
      ...
      />
      <div
        className="relative w-full rounded-sm max-w-[1280px] shadow-lg h-[720px] aspect-video bg-white z-20 mx-auto overflow-hidden flex flex-col p-[60px] pl-[72px] pr-[72px] "
        style={{
      ...
      >
        ...
        <div className="flex flex-col mb-[50px]">
          <h1
            className="text-[42.7px]  font-bold leading-[1.05] tracking-[-2.0px]  mb-4"
            style={{
          ...
          <div
            ...
            style={{
              backgroundColor: "var(--primary-color,#c25de2)",
            }}
          />
        </div>
        ...
        <div className="flex flex-row justify-between items-start gap-[80px] flex-1">
          {columns?.map((column, index) => (
            <div key={index} className="flex-1 flex flex-col">
              <div
                className="text-[85.3px] font-normal leading-none mb-[12px]"
                style={{
              ...
              <div
                className="text-[28.4px] font-normal leading-tight mb-[5px] min-h-[70px]"
                style={{
              ...
              <div className="flex flex-col gap-8">
                <div className="flex flex-col gap-[6px]">
                  <div
                    className="text-[21.3px] font-normal uppercase tracking-[1px]"
                    style={{
                  ...
                  <div
                    className="text-[23.1px] font-normal leading-[1.4]"
                    style={{
                      color: "var(--background-text,#000000)",
                    }}
                  >
