...
export const Schema = z.object({
  title: z
    ...
    .max(20)
    .default("Word of Wisdom"),
  quote: z
    .string()
    .describe("Quotation text displayed")
    .max(200)
    .default(
  ...
  backgroundImage: z
    .object({
      __image_url__: z
        .string()
        .describe("URL of the background image")
        .default(
          "https://images.pexels.com/photos/33508509/pexels-photo-33508509.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        ),
      __image_prompt__: z
        .string()
        .describe("Prompt description for the image")
        .default(
          "Inspirational mountain landscape with dramatic sky and clouds",
        ),
    })
    .default({
      __image_url__:
  ...
  author: z
    .string()
    .describe("Attribution name for the quote")
    .max(30)
        ...
        <div className="absolute inset-0">
          <img
            src={
              ...
              "https://presenton-public.s3.ap-southeast-1.amazonaws.com/users/79e3281f-47a3-4e45-9c74-b495089583cb/xml-to-html/6cdcb19a975e4a02e2543f953b66a74c.jpeg"
            }
