    ...
    .array(
      z.object({
        number: z
          .string()
          .max(5)
          .describe("Sequence number or index")
          .default("1"),
        label: z
          .string()
          .max(40)
          .describe("Label text for the item")
          .default("Introduction"),
      }),
    )
    .describe("List of items displayed in two columns")
    .default([
 ...
 */
const dynamicSlideLayout: React.FC<{ data: Partial<DataProps> }> = ({
  data,
}) => {
  ...
  return (
    <>
      ...
      />
      <div
        className="relative w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-[#FFFFFE] z-20 mx-auto overflow-hidden flex items-center px-[90px] font-['Poppins']"
        style={{
      ...
      >
        ...
        <div className="flex-[1.2] flex flex-col justify-center h-full">
          <div className="max-w-[400px]">
            <h1
              className="text-[42.7px] font-bold  leading-[1.05] tracking-[-2px] whitespace-pre-wrap"
              style={{
            ...
            <div
              className="w-[116.6px] h-[5.7px] mt-[12px]"
              style={{
        ...
        <div className="flex-[1.8] flex justify-between items-center h-full py-[100px] gap-8">
          ...
          <div className="flex flex-col gap-[55px] flex-1">
            {firstCol.map((item, index) => (
              ...
              >
                <div
                  className="w-[50.8px] h-[50.3px] rounded-full flex items-center justify-center shrink-0"
                  style={{
                    backgroundColor: "var(--primary-color,#703AC9)",
                  }}
                >
                  <span
                    className="text-[20.6px] font-normal leading-none"
                    style={{
                ...
                <span
                  className="text-[20.6px] font-normal truncate"
                  style={{
