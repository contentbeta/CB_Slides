...
export const Schema = z.object({
  title: z
    ...
    .default("Key Insights & Learnings"),
  insightTitle: z
    .string()
    .max(63)
    .describe("Heading for the highlighted card")
    .default("CONTENT + PAID SOCIAL COMBINATION DRIVES HIGHEST QUALITY LEADS"),
  insightDescription: z
    .string()
    .max(99)
    .describe("Description text for the highlighted card")
    .default(
...
const dynamicSlideLayout: React.FC<{
  ...
  return (
    <>
      ...
      />
      <div
        className="relative w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-[#FFFFFE] z-20 mx-auto overflow-hidden flex items-center px-16 "
        style={{
      ...
      >
        ...
        <div className="w-1/2">
          <div className="  p-12">
            <div
              className="p-10 py-24 bg-white shadow-md rounded-lg"
              style={{
