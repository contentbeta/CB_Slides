...
export const layoutDescription =
  "A dashboard layout featuring a title and description, up to 4 bullet points, and 1-4 auto-arranged charts in a responsive grid. Supports bar (vertical, horizontal, grouped, stacked, clustered, diverging), line, area, pie, donut, and scatter charts.";
...
const MultiSeriesDataPointSchema = z.object({
  ...
  values: z
    .any()
    .describe(
      "Object with series names as keys and numbers as values (e.g., { 'Product A': 45, 'Product B': 62 })",
    ),
});
...
const CustomTooltip = ({ active, payload, label }: any) => {
  if (active && payload && payload.length) {
    return (
      ...
      >
        <p
          className="text-[10px] font-semibold text-gray-800 mb-1"
...
const MiniChartRenderer: React.FC<{
  ...
  const graphColors = (index: number, serieColor?: string) => {
    const fallback =
      serieColor || CHART_COLOR_PALETTES[index % CHART_COLOR_PALETTES.length];
...
const MultiChartGridWithBulletsSlideLayout: React.FC<
  MultiChartGridWithBulletsSlideLayoutProps
> = ({ data: slideData }) => {
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          background:
            "var(--background-color, linear-gradient(135deg, #f8fafc 0%, #ffffff 50%, #eef2ff 100%))",
        }}
      >
        {/* Decorative elements */}
          ...
          <div className="mb-4 shrink-0">
            <div className="max-w-[760px]">
              ...
              <div
                ...
                style={{ backgroundColor: "var(--primary-color, #ab51c9)" }}
              />
              <p
                ...
                {bullets.map((bullet, index) => (
                  <div key={index} className="flex items-start gap-2">
                    <span
                      ...
                      style={{
                        backgroundColor: "var(--primary-color, #ab51c9)",
                      }}
                    />
                    <span
