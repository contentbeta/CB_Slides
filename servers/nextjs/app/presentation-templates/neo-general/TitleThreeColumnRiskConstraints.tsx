...
export const Schema = z.object({
  ...
  items: z
    .array(
      z.object({
        bgTitle: z
          .string()
          .max(10)
          .describe("Large category label displayed prominently")
          .default("MARKET"),
        subtitle: z
          .string()
          .max(20)
          .describe("Secondary heading for the item")
          .default("Market Saturation"),
        description: z
          .string()
          .max(70)
          .describe("Detailed description text for the item")
          .default(
    ...
    .max(3)
    .describe("List of category items with details")
    .default([
      {
        bgTitle: "MARKETbaba",
          ...
          {items &&
            items.map((item, index) => (
              <div key={index} className="relative w-[334.8px]">
                ...
                >
                  <span
                    className="text-[53.3px] font-normal uppercase"
                ...
                <div className="flex items-center gap-[10px] mt-[10px] mb-[15px]">
                  ...
                  />
                  <span
                    className="text-[17.4px] font-normal leading-[27.8px]"
                    style={{ color: "var(--background-text,#4D5463)" }}
                  >
                    {item.subtitle}
                  </span>
