    ...
    .array(
      z.object({
        ...
        bio: z
          .string()
          .max(100)
          .describe("Brief biography or description text"),
      }),
    )
    .max(4)
    .describe("List of person cards, up to 4 items")
    .default([
      {
        name: "Hannah Morales",
      ...
      },
      {
        ...
        image: {
          __image_url__:
            "https://presenton-public-assets.s3.ap-southeast-1.amazonaws.com/replaceable_template_image.png",
          __image_prompt__:
            "Professional headshot of a female technology leader",
        },
        bio: "Focus on companies with 500+ employees.",
      },
      {
        ...
        image: {
          __image_url__:
            "https://presenton-public-assets.s3.ap-southeast-1.amazonaws.com/replaceable_template_image.png",
          __image_prompt__:
            "Professional headshot of a male creative professional",
        },
        bio: "Focus on companies with 500+ employees.",
      },
    ]),
...
const dynamicSlideLayout: React.FC<{
  ...
  return (
    <>
      ...
      />
      <div
        className="relative w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-[#FFFFFE] z-20 mx-auto overflow-hidden flex flex-col p-[80px] font-['Poppins']"
        style={{
      ...
      >
        ...
        <div className="absolute left-[52px] top-[34px] opacity-0">
          <span
            className="text-[20px] font-normal tracking-[5px]"
        ...
        <div className="flex justify-between items-start mb-[80px]">
          <div className="flex flex-col basis-1/2">
            <h1
              className="text-[42.7px] font-bold leading-[1.1] tracking-[-1.6px] mb-[16px]"
          ...
          {teamMembers?.map((member, index) => (
            <div key={index} className="flex flex-col flex-1 max-w-[215px]">
              ...
              <div className="mb-[30px] h-[50px] flex flex-col justify-end">
                <h2
                  className="text-[18px]  font-medium leading-[1.4] tracking-[-0.1px]"
                  style={{ color: "var(--background-text,#2B3A38)" }}
                >
                  {member?.name}
                </h2>
                <p
                  className="text-[18px] font-normal leading-[1.4] tracking-[-0.1px]"
                  style={{ color: "var(--background-text,#A8ABA3)" }}
                >
                  {member?.designation}
                </p>
              </div>
