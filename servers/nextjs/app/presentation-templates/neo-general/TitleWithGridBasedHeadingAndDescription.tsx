    ...
    .array(
      z.object({
        ...
        description: z
          .string()
          .max(46)
          .describe("Description text for the card"),
      }),
    )
    .describe("Array of cards with heading and description")
    .default([
      {
...
const dynamicSlideLayout: React.FC<{
  ...
  return (
    <>
      ...
      />
      <div
        className="relative w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-[#FFFFFE] z-20 mx-auto overflow-hidden p-16 font-['Poppins']"
        style={{
