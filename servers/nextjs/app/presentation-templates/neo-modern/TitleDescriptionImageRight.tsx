...
export const Schema = z.object({
  title: z
    ...
    .default("Image with Description"),
  description: z
    .string()
    .max(350)
    .describe("The body text or description of the slide")
    .default(
  ...
  image: z
    .object({
      ...
      __image_prompt__: z
        .string()
        .max(100)
        .describe("A description for generating a replacement image"),
    })
    .describe("The large image displayed on the right side of the slide")
    .default({
      __image_url__:
        "https://presenton-public-assets.s3.ap-southeast-1.amazonaws.com/replaceable_template_image.png",
      __image_prompt__:
        "Close up of diverse business hands joined together in a circle, representing teamwork and partnership.",
    }),
});
...
export const layoutDescription =
  "A two-column slide with a title and description on the left and a large featured image on the right. The balanced layout provides equal emphasis on textual content and visual representation.";
...
const dynamicSlideLayout: React.FC<{
  ...
  return (
    <>
      ...
      />
      <div
        className="relative w-full h-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-[#FFFFFE] z-20 mx-auto overflow-hidden font-['Montserrat'] font-normal"
        style={{
