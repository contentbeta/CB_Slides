...
export const Schema = z.object({
  title: z
    ...
    .default("Title Description Metrics Image"),
  description: z
    .string()
    .max(150)
    .describe("Supporting description text")
    .default(
      "A clean professional slide featuring a title, description, a 2x2 grid of highlight metrics, and a large vertical image on the right.",
    ),
  metrics: z
    .array(
      z.object({
    ...
    .max(4)
    .describe("Collection of metric items displayed in a grid")
    .default([
  ...
  image: z
    ...
    .default({
      ...
      __image_prompt__:
        "A professional business collaboration scene with people putting their hands together in the center.",
    })
    .describe(
      "The primary visual image displayed on the right side of the slide.",
    ),
});
...
export const layoutDescription =
  "A slide featuring a title, description, and 2x2 metrics grid on the left with a large vertical image on the right. The alternating metric cards create visual hierarchy.";
        ...
        <div className="flex h-full w-full">
          ...
          <div className="flex-[1.2] flex flex-col justify-center pl-[52px] pr-[40px] py-[60px]">
            ...
            <div className="mb-8">
              {title && (
                <h1
                  className="text-[#002BB2]  font-bold text-[42.7px] leading-[1.1] tracking-[-1.6px] mb-6"
              ...
              {description && (
                <p
                  className="text-[#c35de4]  font-normal text-[16px] leading-[1.6] max-w-[520px]"
            ...
            <div className="grid grid-cols-2 gap-x-[26px] gap-y-[20px] max-w-[550px]">
              {metrics?.map((metric, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`flex flex-col justify-center p-[28px] rounded-[3.5px] w-[259px] h-[153px] ${
                      isBlueBackground ? "bg-[#6B89E6]" : "bg-[#F7F8FF]"
                    }`}
                    style={{
                  ...
                  >
                    <div
                      className={` font-normal text-[17.8px] leading-[1.4] mb-4 ${
                        isBlueBackground ? "text-white" : "text-[#c35de4]"
                      }`}
                      style={{
                    ...
                    <div
                      className={` font-bold text-[39.3px] leading-tight ${
                        isBlueBackground ? "text-white" : "text-[#c35de4]"
                      }`}
                      style={{
                        color: isBlueBackground
