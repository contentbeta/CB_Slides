...
export const Schema = z.object({
  ...
  description: z
    .string()
    .max(300)
    .describe("A brief description or concluding text")
    .default(
...
export const layoutDescription =
  "A closing slide with a title, description text, and three contact information cards for email, phone, and website, ideal for thank you or contact pages.";
      ...
      >
        <div className="flex flex-col h-full px-[114px] pt-[132px] justify-center ">
          <div className="mb-[60px]">
            <div
              className=" w-[116.6px] h-[3.3px] bg-[#1F8A2E] mb-[10px]"
              style={{ backgroundColor: "var(--primary-color,#1F8A2E)" }}
            />
            <h1
              className="text-[42.7px] text-black  font-bold leading-tight mb-[16px] tracking-[-1.6px]"
              style={{ color: "var(--background-text,#000000)" }}
            >
              {title}
            </h1>
            <p
              className="text-[16px] text-black  leading-[28.5px] max-w-[675px]"
              style={{ color: "var(--background-text,#000000)" }}
            >
              {description}
            </p>
          ...
          {contactItems && contactItems?.length > 0 && (
            <div className="flex justify-start gap-[20px] items-start mt-auto mb-[185px]">
              {contactItems?.map((item, index) => (
                ...
                >
                  ...
                  >
                    {/* Label Header */}
                    <div
                      className="w-full h-[37.7px] bg-[#1F8A2E] rounded-[6px] flex items-center justify-center mb-[36px]"
                      style={{
                        backgroundColor: "var(--primary-color,#1F8A2E)",
                      }}
                    >
                      <span
                        className="text-[21.3px] text-white  font-bold"
                    ...
                    <div className="flex-1 flex items-center justify-center">
                      <span
                        className="text-[21.6px] text-black text-center px-4 leading-[25.9px]"
                        style={{ color: "var(--background-text,#000000)" }}
                      >
                        {item?.value}
                      </span>
