...
export const Schema = z.object({
  ...
  description: z
    .string()
    .max(250)
    .describe("A descriptive paragraph for the slide topic")
    .default(
  ...
  listItems: z
    ...
    .max(5)
    .describe("A list of items with icons, headings, and descriptions")
    .default([
      {
        icon: {
          __icon_url__:
...
export const layoutDescription =
  "A two-column slide with a title and description on the left, and a vertical list of icon-led items on the right, perfect for processes, steps, or feature lists.";
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col basis-1/2 ">
          ...
          <div
            className="w-[116px] h-[3px] bg-[#1F8A2E] mb-4"
            style={{ backgroundColor: "var(--primary-color,#1F8A2E)" }}
          />

          {/* Main Title */}
          <h1
            className="text-[42.7px] text-black  font-bold leading-tight mb-8 tracking-[-1.6px]"
          ...
          {/* Main Description */}
          <p
            className="text-[16px] text-black  leading-[28.5px] max-w-[475px]"
            style={{ color: "var(--background-text,#000000)" }}
          >
            {description}
          </p>
        ...
        <div className="flex flex-col basis-1/2 gap-10">
          {listItems?.map((item, index) => (
            <div key={index} className="flex items-start gap-8">
              {/* Icon Container */}
              <div
                className="flex-shrink-0 w-[65.6px] h-[65.6px] rounded-full border-[1.3px] border-[#1F8A2E] bg-[#ecfaee] flex items-center justify-center p-4"
                style={{
                  borderColor: "var(--stroke,#1F8A2E)",
                  backgroundColor: "var(--primary-color,#ecfaee)",
                }}
              >
                <RemoteSvgIcon
              ...
              <div className="flex flex-col justify-center">
                <h3
                  className="text-[21.3px] text-black  font-bold leading-[25.6px]"
                  style={{ color: "var(--background-text,#000000)" }}
                >
                  {item.heading}
                </h3>
                <p
                  className="text-[16px] text-black  leading-[19.2px] mt-1 max-w-[243px]"
                  style={{ color: "var(--background-text,#000000)" }}
                >
