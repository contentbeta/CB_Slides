...
export const layoutDescription =
  "A neo-standard dashboard with title, description, up to 4 KPI metrics, and 1–6 auto-arranged charts. Supports bar (vertical, horizontal, grouped, stacked, clustered, diverging), line, area, pie, donut, and scatter charts.";
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Area
              ...
              stroke={graphColors(0)}
              strokeWidth={2}
              fill={`url(#areaGrad-std-${chart.title})`}
            />
          </AreaChart>
        </ResponsiveContainer>
      );
...
const TitleDescriptionMultiChartGridWithMetricsLayout: React.FC<
  MultiChartGridSlideLayoutProps
> = ({ data: slideData }) => {
              ...
              <div className="mt-4 grid grid-cols-4 gap-3">
                {metrics.map((metric, index) => (
                  ...
                  >
                    ...
                    <div
                      className="text-[10px] font-medium mt-1 opacity-80"
                      style={{ color: "var(--background-text,#000)" }}
                    >
                      {metric.label}
                    </div>
