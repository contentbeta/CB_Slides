...
export const Schema = z.object({
  title: z
    ...
    .default("Timeline Flow"),
  description: z
    .string()
    .max(300)
    .describe("A detailed description on the left side of the slide")
    .default(
    ...
    .array(
      z.object({
        ...
        eventDescription: z
          .string()
          .max(100)
          .describe("Brief description of the timeline event"),
      }),
    )
    .max(5)
    .describe("A list of events for the timeline")
    .default([
      {
        icon: {
          __icon_url__:
        ...
        year: "2021",
        eventDescription: "Briefly elaborate on what you want to discuss.",
      },
      {
        icon: {
          __icon_url__:
...
export const layoutDescription =
  "A two-column slide with a title and description on the left, and a vertical timeline of events with year markers on the right, ideal for milestones or history.";
...
const dynamicSlideLayout: React.FC<{
  ...
  return (
    <>
      ...
      />
      <div
        className="relative w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-[#FFFFFE] z-20 mx-auto overflow-hidden flex items-center"
        style={{
