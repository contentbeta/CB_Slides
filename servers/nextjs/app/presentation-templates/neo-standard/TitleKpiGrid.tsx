    ...
    .array(
      z.object({
        value: z
          .string()
          .max(5)
          .describe("The numeric value or percentage for the KPI"),
        description: z
          .string()
          .max(25)
          .describe("The text description or label for the KPI"),
      }),
    )
    .max(8)
    .describe("A list of up to 8 KPI items")
    .default([
...
export const layoutDescription =
  "A slide featuring a centered title followed by a flexible grid of up to 8 KPI metric boxes with values and descriptions, perfect for dashboards and reports.";
...
const dynamicSlideLayout: React.FC<{
  ...
  return (
    <>
      ...
      />
      <div
        className="relative w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-[#FFFFFE] z-20 mx-auto overflow-hidden flex flex-col items-center justify-center py-16 px-20"
        style={{
