...
export const Schema = z.object({
  ...
  points: z
    ...
    .max(3)
    .describe("A list of key summary points")
    .default([
  ...
  cards: z
    .array(
      z.object({
        ...
        percentageValue: z
          .number()
          .describe("The percentage value to be shown in the donut chart"),
        footerHeading: z
          .string()
          .max(30)
          .describe("The descriptive label in the card footer"),
        footerDescription: z
          .string()
          .max(30)
          .describe("The specific detail in the card footer"),
      }),
    )
    .min(2)
    .max(6)
    .describe("A list of up to 6 data cards")
    .default(
      Array(6).fill({
        heading: "Research",
        percentageValue: 99,
...
export const layoutDescription =
  "A slide with a title and numbered summary points on the left, paired with a 2x3 grid of analytical cards featuring donut progress charts on the right.";
        ...
        <div className="flex h-full w-full">
          ...
          <div className="flex flex-col justify-center w-[48%] pl-[89.6px] pr-8">
            <div className="mb-4">
              ...
              />
              <h1
                className="text-[42.7px] text-[#101828]  font-bold leading-[1.1] tracking-[-1.6px] mb-8"
            ...
            <div className="space-y-4">
              {points?.map((point, index) => (
                <div
                  key={index}
                  className="flex items-start text-[16px] leading-[1.8] text-[#4D5463]"
                >
                  <span
                    className="text-[#000000] mr-2 flex-shrink-0"
                    style={{ color: "var(--background-text,#000000)" }}
                  >
                    {index + 1}.
                  </span>
                  <p
                    className="text-[#4D5463]"
                    style={{ color: "var(--background-text,#000000)" }}
                  >
                    {point}
                  </p>
          ...
          <div className="flex-1 flex items-center justify-center p-8">
            <div className="grid grid-cols-2 gap-4">
              {cards?.map((card, index) => (
                <div
                  key={index}
                  className="w-[230px] h-[212.8px] bg-[#FEFEFE] border-[0.7px] border-[#EBEBEB] rounded-lg p-3 flex flex-col items-center justify-between"
                  style={{
                    backgroundColor: "var(--card-color,#FEFEFE)",
                    borderColor: "var(--stroke,#EBEBEB)",
                  }}
                >
                  <div
                    className="text-[15.8px] text-[#000000] mt-1"
                    style={{ color: "var(--background-text,#000000)" }}
                  >
                    {card.heading}
                  </div>
                  ...
                  <div className="text-center mb-1">
                    <p
                      className="text-[12.6px] text-[#000000] leading-tight"
                      style={{ color: "var(--background-text,#000000)" }}
                    >
                      {card.footerHeading}
                    </p>
