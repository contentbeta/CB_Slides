  ...
  graph: z
    .object({
      columns: z
        ...
        .max(2)
        .describe("Columns for the chart data"),
      rows: z
        .array(
          z.object({
...
const dynamicSlideLayout: React.FC<{
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Line
                type="monotone"
                dataKey="value"
                stroke="var(--graph-0, #9CE0EE)"
                strokeWidth={3}
                dot={{ r: 5, fill: "var(--graph-0, #9CE0EE)" }}
                activeDot={{ r: 7 }}
              />
            </LineChart>
          </ResponsiveContainer>
  ...
  return (
    <>
      ...
      />
      <div
        className="relative w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-[#FFFFFE] z-20 mx-auto overflow-hidden flex flex-col font-['Albert_Sans'] pb-[72px]"
        style={{
      ...
      >
        ...
        <div className="flex flex-1 min-h-0 items-center justify-center px-[115px]">
          <div
            className="w-full h-full min-h-0 bg-[#EBEBEB] rounded-[4.7px] border-[1.3px] border-[#F0F0F2] flex flex-col items-center justify-center p-5"
            style={{
              borderColor: "var(--stroke,#F0F0F2)",
              backgroundColor: "var(--card-color,#EBEBEB)",
            }}
          >
                ...
                {graph?.rows?.map((entry, index) => (
                  ...
                  >
                    <div
                      ...
                      style={{
                        backgroundColor: `var(--graph-${index % 10}, ${COLORS[index % COLORS.length]})`,
                      }}
                    />
                    <span
                      style={{
                        ...
                        fontWeight: 400,
                        fontSize: "18px",
                        color: "var(--background-text, #7f8491)",
                      }}
                    >
                      {entry.label}
                    </span>
