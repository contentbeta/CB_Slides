...
export const Schema = z.object({
  ...
  description: z
    .string()
    .max(300)
    .describe("The main paragraph description on the slide")
    .default(
    ...
    .array(
      z.object({
        heading: z
          .string()
          .max(40)
          .describe("The heading for this bullet point"),
        description: z
          .string()
          .max(120)
          .describe("The description for this bullet point"),
      }),
    )
    .max(5)
    .describe(
      "A list of up to 5 bullet points, each with a heading and description",
    )
    .default([
      {
  ...
  footerWebsite: z
    .string()
    .max(30)
    .describe("The website URL displayed in the footer")
...
export const layoutDescription =
  "A clean two-column layout with a main title and description on the left, and up to 5 bullet points on the right. Each bullet has a heading and a short description. Ideal for key takeaways, feature highlights, or structured lists with context.";
      ...
      >
        ...
        <div className="absolute left-[65.3px] top-[175.5px] w-[17.6px] h-[17.6px]">
          <svg viewBox="0 0 17.6 17.6" className="w-full h-full">
            <path
              d="M 8.8 0.0 L 17.6 8.8 L 8.8 17.6 L 0.0 8.8 L 8.8 0.0 Z"
              fill="#4D5463"
            ...
            <div className="flex flex-col w-full max-w-[450px] ml-auto">
              {bullets?.map((item, index) => (
                <div key={index} className="relative">
                  <div
                    className="w-full h-[1px] bg-[#DCE2FA]"
                    style={{ backgroundColor: "var(--stroke,#DCE2FA)" }}
                  />
                  <div className="flex gap-[20px] py-[20px] items-start">
                    <div
                      className="flex-shrink-0 w-[8px] h-[8px] rounded-full mt-[8px] bg-[#4D5463]"
                      style={{
                        backgroundColor: "var(--background-text,#4D5463)",
                      }}
                    />
                    <div className="flex flex-col">
                      <h3
                        className="text-[20.6px] font-bold mb-[4px]"
                        style={{ color: "var(--background-text,#000000)" }}
                      >
                        {item.heading}
                      </h3>
                      <p
                        className="text-[13.2px] leading-[1.4]"
        ...
        <div className="absolute bottom-[20px] left-[72px] right-[72px] flex items-center gap-[20px]">
          ...
          <div
            className="h-[2.7px] flex-grow bg-[#55626E]"
          ...
          <div className="w-[58.1px] h-[58.1px]">
            <svg viewBox="0 0 58.1 58.1" className="w-full h-full">
              <path
                d="M 29.1 0.0 L 58.1 29.1 L 29.1 58.1 L 0.0 29.1 L 29.1 0.0 Z"
                fill="#4D5463"
                style={{ fill: "var(--background-text,#4D5463)" }}
              />
            </svg>
