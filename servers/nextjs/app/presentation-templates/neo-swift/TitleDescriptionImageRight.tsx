...
export const Schema = z.object({
  ...
  description: z
    .string()
    .max(250)
    .describe("The main descriptive text")
    .default(
  ...
  image: z
    ...
    .describe("The primary image on the right side of the slide")
    .default({
      __image_url__:
        "https://presenton-public-assets.s3.ap-southeast-1.amazonaws.com/replaceable_template_image.png",
      __image_prompt__:
        "A diverse team of professionals in business suits stacking their hands together in the center for a team huddle, symbolizing unity and partnership.",
    }),
});
