...
export const Schema = z.object({
  ...
  description: z
    .string()
    .max(120)
    .describe("A brief description or context for the slide content")
    .default(
    ...
    .array(
      z.object({
        ...
        label: z
          .string()
          .max(12)
          .describe("The category or label of the metric"),
        value: z.string().max(6).describe("The numerical or statistical value"),
        subText: z
          .string()
          .max(12)
          .describe("Additional detail or challenge related to the metric"),
      }),
    )
    .max(4)
    .describe("A list of up to 4 metric items")
    .default([
      {
        icon: {
          __icon_url__:
            "https://presenton-public.s3.ap-southeast-1.amazonaws.com/static/icons/placeholder.svg",
          __icon_query__: "search",
        },
        label: "Research",
        value: "8,450",
  ...
  mainImage: z
    ...
    .describe("The primary visual image on the right")
    .default({
      __image_url__:
...
const dynamicSlideLayout = ({
  ...
  return (
    <>
      ...
      />
      <div
        className="relative w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-white z-20 mx-auto overflow-hidden flex flex-col  justify-center "
        style={{
        ...
        <div className="flex items-center gap-[60px] px-[60px]  mb-4">
          ...
          <div className="flex flex-col basis-1/2">
            <div className="mb-[24px]">
              <h1
                className="text-[42.7px] text-black  font-bold leading-[1.1] tracking-[-1.6px] whitespace-pre-line"
              ...
              {metrics?.map((metric, index) => (
                ...
                >
                  <div className="flex items-center justify-between mb-1">
                    <div
                      className="bg-white rounded-[10px] w-[48px] h-[50px] flex items-center justify-center border-[0.7px] border-[#EBEBEB]"
                    ...
                    <div className="flex flex-col flex-1 items-end pr-2">
                      <span
                        className="text-[14px] text-[#4D5463] "
                        style={{ color: "var(--primary-text,#4D5463)" }}
                      >
                        {metric.label}
                      </span>
                      <span
                        className="text-[36px] text-black  leading-[1]"
                  ...
                  <div className="mt-auto text-center border-t border-[#EBEBEB] pt-1">
                    <p
                      className="text-[12.6px] text-[#4D5463]  truncate"
                      style={{ color: "var(--primary-text,#4D5463)" }}
                    >
                      {metric.subText}
                    </p>
