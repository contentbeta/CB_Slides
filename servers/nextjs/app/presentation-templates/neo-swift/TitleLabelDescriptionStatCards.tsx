...
export const Schema = z.object({
  ...
  label: z
    .string()
    .max(5)
    .describe("A short subtitle or category label")
    .default("Leads"),
  description: z
    .string()
    .max(205)
    .describe("The primary body text explaining the summary")
    .default(
    ...
    .array(
      z.object({
        ...
        content: z
          .string()
          .max(45)
          .describe("The descriptive text for the statistic"),
      }),
    )
    .max(3)
    .describe("A list of 3 statistics cards")
    .default([
      {
        value: "10K",
        heading: "USERS",
        content: "Active users across multiple industries",
      },
      {
        value: "90%",
        heading: "REVENUE GROWTH",
        content: "Year-over-year revenue growth",
      },
      {
        value: "150%",
        heading: "CUSTOMER SATISFACTION",
        content: "Retention rate with an average rating of 4.8/5",
      },
    ]),
});
        ...
        <div className="flex flex-row flex-1 px-[72px]">
          ...
          <div className="flex flex-col basis-1/2 pt-[110px]">
            ...
            <div className="mb-[40px]">
              <h1
                className="text-[42.7px]  font-bold leading-[43.9px] tracking-[-1.6px]"
            ...
            <div className="flex items-center gap-[10px] mb-[28px]">
              <div
                className="w-[15.8px] h-[15.8px] bg-black rounded-full shrink-0"
                style={{ backgroundColor: "var(--background-text,#000000)" }}
              />
              <span
            ...
            <p
              className="text-[16px]  leading-[28.5px] max-w-[435px]"
              style={{ color: "var(--background-text,#000000)" }}
            >
              {description}
            </p>
            ...
            {stats?.map((stat, index) => (
              ...
              >
                ...
                <div className="flex flex-col justify-center">
                  <span
                    className="text-[10.7px]  font-bold uppercase tracking-wider mb-[2px]"
                    style={{ color: "var(--primary-text,#000000)" }}
                  >
                    {stat?.heading}
                  </span>
