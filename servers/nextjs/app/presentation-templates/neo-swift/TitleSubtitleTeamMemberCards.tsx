...
export const Schema = z.object({
  ...
  subtitle: z
    .string()
    .max(300)
    .describe("A descriptive sub-heading explaining the team's focus")
    .default(
    ...
    .array(
      z.object({
        ...
        designation: z
          .string()
          .max(40)
          .describe("Job title or role of the team member"),
        image: z
          .object({
        ...
        summary: z
          .string()
          .max(100)
          .describe("Short summary or focus area of the team member"),
      }),
    )
    .max(4)
    ...
    .default([
      {
        ...
        image: {
          ...
          __image_prompt__:
            "Professional headshot of a female executive smiling",
        },
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center text-center mb-16 px-12 pt-12">
          <h1
            className="text-[42.7px] font-bold tracking-[-1.6px] mb-4"
            style={{ color: "var(--background-text,#000000)" }}
          >
            {title}
          </h1>
          <p
            className="text-[16px]  leading-[1.6] max-w-[800px]"
            style={{ color: "var(--background-text,#000000)" }}
          >
            {subtitle}
          </p>
        ...
        <div className="flex justify-center items-start gap-[43px] flex-grow px-12">
          {teamMembers?.map((member, index) => (
            <div
              key={index}
              className="flex flex-col bg-[#BEF4FE] rounded-[11.3px] border-[0.7px] border-[#EBEBEB] w-[214.6px] h-[339.8px] overflow-hidden"
              style={{
            ...
            >
              <div className="flex flex-col items-center justify-center py-4 px-2 min-h-[64px]">
                <span
                  className="text-[17.8px]  tracking-[-0.1px] line-clamp-1"
                  style={{ color: "var(--primary-text,#000000)" }}
                >
                  {member?.name}
                </span>
                <span
                  className="text-[14.2px]  tracking-[-0.1px] line-clamp-1"
              ...
              <div className="flex-grow flex items-center justify-center text-center p-3">
                <span
                  className="text-[16px]  leading-[1.2] line-clamp-2"
                  style={{ color: "var(--primary-text,#000000)" }}
                >
                  {member?.summary}
                </span>
