...
export const Schema = z.object({
  ...
  tagline: z
    .string()
    .max(15)
    .describe("A short tagline or label displayed with a bullet")
    .default("Leads"),
  description: z
    .string()
    .max(300)
    .describe("The main paragraph description on the left side of the slide")
    .default(
    ...
    .array(
      z.object({
        ...
        description: z
          .string()
          .max(100)
          .describe("The detailed description for this step"),
      }),
    )
    .max(4)
    .describe("A list of up to 4 numbered steps with titles and descriptions")
    .default([
      {
      ...
      >
        ...
        <div className="absolute left-[65.3px] top-[175.5px] w-[17.6px] h-[17.6px]">
          <svg viewBox="0 0 17.6 17.6" className="w-full h-full">
            <path
              ...
              fill="#4D5463"
              style={{ fill: "var(--background-color,#4D5463)" }}
            />
          </svg>
        </div>
        ...
        <div className="flex  h-full w-full px-[72px] pt-[190px] pb-[90px] gap-[60px]">
          ...
          <div className="flex flex-col basis-[45%]">
            <h1
              className="text-[42.7px]  font-bold leading-[1.1] tracking-[-1.6px] mb-[40px]"
            ...
            <div className="flex items-center gap-[10px] mb-[28px]">
              <svg width="16" height="16" viewBox="0 0 16 16">
                <circle
                  ...
                  r="8"
                  fill="#000000"
                  style={{ fill: "var(--background-text,#000000)" }}
                />
              </svg>
              <span
                className="text-[17.4px] "
              ...
              {steps?.map((step, index) => (
                <div key={index} className="relative">
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: "var(--background-color,#DCE2FA)",
                    }}
                  />

                  <div className="flex gap-[24px] py-[24px] items-start">
                    <div
                      className="relative flex-shrink-0 w-[60px] h-[60px] flex items-center justify-center bg-[#BEF4FE] rounded-full"
                      style={{
                        backgroundColor: "var(--primary-color,#BEF4FE)",
                      }}
                    >
                      <span
                        className="text-[19.6px]  font-bold"
                    ...
                    <div className="flex flex-col">
                      ...
                      <p
                        className="text-[13.2px]  leading-[1.3]"
                        style={{ color: "var(--background-text,#4D5463)" }}
                      >
                        {step.description}
                      </p>
