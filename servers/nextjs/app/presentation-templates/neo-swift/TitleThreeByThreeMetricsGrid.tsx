    ...
    .array(
      z.object({
        label: z
          .string()
          .max(12)
          .describe("The small label at the top of the card"),
        value: z.string().max(10).describe("The large central value or metric"),
        detail: z
          .string()
          .max(25)
          .describe("A short description or challenge detail"),
        isHighlighted: z
          .boolean()
          .describe("Whether the card should be highlighted")
          .default(false),
      }),
    )
    .max(9)
    .describe("A list of 1-9 comparison metrics")
    .default([
      {
        label: "Research",
        value: "8,450",
        detail: "Main Challenge: Delayed Client",
        isHighlighted: false,
      },
      {
        label: "Research",
      ...
      <div
        style={{
          ...
          backgroundColor: highlighted
            ? "var(--card-color,#BEF4FE)"
            : "transparent",
          boxShadow: highlighted
            ? "0 0 0 1px var(--stroke,rgba(0,0,0,0.08))"
            : "none",
            ...
            <div key={rowIndex}>
              ...
              >
                {rowItems?.map((item, colIndex) => (
                  <Card key={colIndex} item={item} showDivider={true} />
                ))}
              </div>
            </div>
          ))}
