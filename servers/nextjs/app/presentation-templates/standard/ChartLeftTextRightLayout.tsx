...
const layoutDescription =
  "A slide with header label, a left-side inline bar chart, and right-side title with paragraph.";
...
const ChartDatumSchema = z.object({
  label: z
    ...
    .max(12)
    .default("A")
    .meta({ description: "Category label" }),
  value: z
    .number()
    .min(0)
    .max(100)
    .default(60)
    .meta({ description: "Value 0–100" }),
});
...
const chartFont = (element: HTMLElement) =>
  resolveCssValue(
    element,
    "var(--heading-font-family,Playfair Display)",
    "Playfair Display",
  ).replace(/^['"]|['"]$/g, "");
              ...
              datasets: [
                {
                  ...
                  data: values,
                  backgroundColor:
                    type === "line" ? colors[0] || CHART_COLORS[0] : colors,
      ...
      >
        ...
        <div className="grid grid-cols-2 h-[calc(100%-64px)]">
          ...
          <div className="h-full px-12 flex flex-col justify-center">
            ...
            <p
              className="mt-6 text-[16px] leading-[28px]"
