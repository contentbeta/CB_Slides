...
const ImageSchema = z.object({
  ...
  __image_prompt__: z
    ...
    .max(120)
    .default(
      "Muted cover background image with subtle subject suitable for contact slide",
    )
    .meta({
...
const layoutDescription =
  "A slide with a top bar, left media with overlay and bottom bar, and right content with header and text blocks. This should only be used for contact information.";
        ...
        <div className="px-10 pt-4 pb-8 h-[calc(100%-72px)]">
          <div className="grid grid-cols-[640px_1fr] gap-x-16 h-full">
            ...
            <div className="h-full flex flex-col">
              <h1
                className=" text-[64px] leading-[1.12] font-semibold mb-8 whitespace-pre-line"
                style={{ color: "var(--background-text, #111827)" }}
              >
                {slideData?.rightContent?.title ||
                  "Let’s Get in\nTouch with Us"}
              </h1>
              ...
              <div className="mb-6">
                {sections.map((sec, idx) => (
                  <div
                    key={idx}
                    className={idx < sections.length - 1 ? "mb-6" : "mt-2"}
                  >
                    <div
