...
const ImageSchema = z.object({
  ...
  __image_prompt__: z
    ...
    .max(150)
    .default(
      "Small decorative photo partially behind the card showing a business theme",
    )
    .meta({
...
const layoutDescription =
  "A slide with a left strip, top label with rule, right header, right description, floating small image, and a centered card with ...cards.";

const Schema = z.object({
  metaMaxWords: z.number().default(200).meta({
    description:
      "Maximum number of words the text areas can handle collectively.",
  }),
      ...
      >
        ...
        <div className="grid grid-cols-2 h-full">
          <div className="relative bg-[#efefef]">
            ...
            <div className="pt-6 pl-10 pr-6 relative z-[1]">
              <div className="flex items-center gap-6">
                ...
                <div
                  className="h-[2px] w-[220px] rounded-full"
          ...
          <div className="relative px-12 pt-16">
            <h1
              className=" leading-[72px] text-[64px] tracking-tight whitespace-pre-line font-semibold"
              style={{ color: "var(--background-text, #111827)" }}
            >
        ...
        <div className="absolute left-10 right-10 top-[320px] z-10">
          <div
            className="w-fit max-w-full rounded-md shadow-[0_20px_60px_rgba(0,0,0,0.12)] ml-auto"
              ...
              <div className="grid grid-flow-col auto-cols-max gap-6">
                {cards.map((card, idx) => (
                  <div key={idx} className="flex flex-col items-center">
                    <div
                      className="w-[240px] h-[64px] rounded-sm text-white flex items-center justify-center  text-[22px]"
                      style={{
                    ...
                    <p
                      className="mt-6 text-center text-[16px] leading-[28px]  max-w-[240px]"
