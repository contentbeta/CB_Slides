...
const ImageSchema = z.object({
  ...
  __image_prompt__: z
    ...
    .max(180)
    .default(
      "Decorative abstract office scene photo placed at lower right on the band",
    )
    .meta({
...
const layoutDescription =
  "A slide with a small header label and number, a left card of ...cards with round symbols and titles with descriptions, a large heading with supporting text, and a decorative image on a mid-page band";

const Schema = z.object({
  metaMaxWords: z.number().default(240).meta({
    description:
      "Maximum number of words any single text field can handle in this layout",
  }),
  ...
  cards: z
    .array(
      z.object({
        ...
        symbolIcon: IconSchema.default({
          __icon_url__:
            "https://presenton-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/fediverse-logo-bold.png",
    ...
    .default([
      ...
      },
      {
        ...
        symbolIcon: {
          __icon_url__:
            "https://presenton-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/video-bold.png",
          __icon_query__: "info icon",
        },
      ...
      },
      {
        ...
        symbolIcon: {
          __icon_url__:
            "https://presenton-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/receipt-x-bold.png",
          __icon_query__: "info icon",
        },
      ...
      },
      {
        ...
        symbolIcon: {
          __icon_url__:
            "https://presenton-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/users-four-bold.png",
          __icon_query__: "info icon",
        },
        title: "Customer-Centric Disruption",
        description:
    ...
    .meta({
      description:
        "Array of ...cards with a round symbol, title and description. Max 6 items",
    }),
      ...
      >
        ...
        <div className="relative z-10 grid grid-cols-[600px_1fr] gap-[64px] px-[80px] pt-[12px]">
          <div className="w-[600px]">
            <div
              className="rounded-[10px] shadow-[0_20px_60px_rgba(0,0,0,0.08)] px-[36px] py-[28px]"
              ...
              <ul className="flex flex-col gap-[28px]">
                {cards.map((item, idx) => (
                  <li key={idx} className="flex items-start gap-[24px]">
                    <div
                      className="w-[88px] h-[88px] rounded-full flex items-center justify-center overflow-hidden select-none"
                      style={{
                    ...
                    >
                      {item.symbolIcon?.__icon_url__ ? (
                        ...
                        <span
                          ...
                          style={{ color: "var(--primary-color, #1B8C2D)" }}
                        >
                          {item.symbolText}
                        </span>
                      )}
                    ...
                    <div className="flex-1">
                      ...
                      <p
                        className=" text-[16px] leading-[1.55] mt-[8px]"
          ...
          <div className="pt-[28px]">
            <h1
              className="font-['Playfair Display'] text-[64px] leading-[1.05] tracking-[-0.01em] max-w-[600px] font-semibold"
              style={{ color: "var(--background-text, #111827)" }}
              dangerouslySetInnerHTML={{
                __html: (
                  slideData?.rightTitle || "Disrupting the\nIndustry"
                ).replace(/\n/g, "<br/>"),
              }}
            ></h1>
            <div
              className="mt-[24px] inline-block rounded-md px-6 py-4"
              style={{ backgroundColor: "var(--card-color, #F3F4F6)" }}
            >
              <p
                className="font-['Playfair Display'] text-[16px] leading-[1.6] max-w-[620px]"
                style={{ color: "var(--background-text, #6B7280)" }}
              >
