...
const ImageSchema = z.object({
  __image_url__: z
    .string()
    .url()
    .default("https://via.placeholder.com/900x500")
    .meta({
  ...
  __image_prompt__: z
    ...
    .min(10)
    .max(200)
    .default("Wide landscape placeholder representing a slide image area")
    .meta({
...
const IconSchema = z.object({
  ...
  __icon_query__: z
    ...
    .min(3)
    .max(30)
    .default("camera landscape placeholder")
    .meta({
...
const layoutDescription =
  "A slide with a top bar, centered title, placeholder icon area, and a colored card with circular icon, heading, and paragraph";
...
const Schema = z
  .object({
    ...
    title: z
      ...
      .min(24)
      .max(56)
      .default("Transforming Ideas into\nReality")
      .meta({
        description: "Main title split across up to two lines. Max 10 words",
      }),
    backgroundImage: ImageSchema.default({
      __image_url__:
        "https://images.unsplash.com/photo-1650831432942-aa352df4e9b4?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      __image_prompt__:
        "Background image covering the entire section behind the card",
    }).meta({
    ...
    card: z
      .object({
        circleIcon: IconSchema.default({
          __icon_url__:
            "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='30' height='30' viewBox='0 0 24 24' fill='%230A8016' aria-hidden='true'><path d='M10 6V7H7C5.895 7 5 7.895 5 9V18C5 19.105 5.895 20 7 20H17C18.105 20 19 19.105 19 18V9C19 7.895 18.105 7 17 7H14V6C14 4.895 13.105 4 12 4H12C10.895 4 10 4.895 10 6ZM12 6C12.552 6 13 6.448 13 7H11C11 6.448 11.448 6 12 6ZM7 9H17V11H7V9Z'/></svg>",
        ...
        heading: z
          ...
          .min(22)
          .max(70)
          .default("Idea Generation and Validation")
          .meta({
      ...
      >
        <div className="flex items-center justify-between px-10 pt-6">
          <div className="flex items-center gap-6">
            ...
            <div
              className="h-[3px] w-[230px] rounded-full"
        ...
        <div className="px-10 pt-5 pb-6">
          <h1
            className="text-[64px] leading-[1.05] text-center font-semibold"
            style={{
        ...
        <div className="relative flex-1 flex items-center justify-center">
          ...
          ></div>
          <div
            className="relative w-[900px] max-w-[92%] rounded-md shadow-[0_30px_90px_rgba(0,0,0,0.18)]"
          ...
          >
            <div className="p-10 grid grid-cols-[72px,1fr] gap-6">
              ...
              <div className="min-w-0">
                <div
                  className="text-white text-[28px] leading-[34px] font-semibold"
                  style={{
                    fontFamily: "Playfair Display",
                ...
                <p
                  className="mt-3 text-white/95 text-[16px] leading-[28px]"
                  style={{
                    fontFamily: "Playfair Display",
                    color: "var(--primary-text, #FFFFFF)",
                  }}
