...
const ImageSchema = z.object({
  ...
  __image_prompt__: z
    ...
    .max(200)
    .default(
      "Elegant abstract green themed background for a presentation slide, minimal shapes, soft lighting",
    )
    .meta({
...
const IconSchema = z.object({
  __icon_url__: z
    .string()
    .default("https://static.thenounproject.com/png/1783767-200.png")
    .meta({
...
const layoutDescription =
  "A slide with a top utility row, a header, a tagline, and a grid of cards each with a number block and text";
...
const Schema = z.object({
  title: z
    ...
    .min(12)
    .max(70)
    .default("Scaling New Heights Together")
    .meta({
      description:
        "Main title. Single line up to ~34 chars or two lines up to ~70 chars. Max 9 words",
    }),
  tagline: z
    .string()
    .min(40)
  ...
  decorativeLine: ImageSchema.default({
    __image_url__:
      "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='220' height='2' viewBox='0 0 220 2'><rect width='220' height='2' rx='1' fill='%230B8E26'/></svg>",
    ...
    .default([
      {
        ...
        icon: {
          __icon_url__: "https://static.thenounproject.com/png/1783767-200.png",
          __icon_query__: "happy customer icon",
        },
      },
      {
        number: "2.5",
        ...
        icon: {
          __icon_url__: "https://static.thenounproject.com/png/1783767-200.png",
          __icon_query__: "users group icon",
        },
      },
      {
        number: "99",
        ...
        icon: {
          __icon_url__: "https://static.thenounproject.com/png/1783767-200.png",
          __icon_query__: "server uptime icon",
        },
      },
      {
        number: "142",
        ...
        icon: {
          __icon_url__: "https://static.thenounproject.com/png/1783767-200.png",
          __icon_query__: "handshake deal icon",
        },
      },
      {
        number: "32",
        ...
        icon: {
          __icon_url__: "https://static.thenounproject.com/png/1783767-200.png",
          __icon_query__: "growth chart icon",
        },
      },
      {
        number: "500",
        ...
        icon: {
          __icon_url__: "https://static.thenounproject.com/png/1783767-200.png",
          __icon_query__: "leaf sustainability icon",
        },
      },
    ])
    .meta({
      description:
        "Grid of cards with number block, subtitle, and body (<=100 chars)",
    }),
    ...
    <>
      ...
      >
        <div className="h-full flex flex-col px-10 pt-6 pb-8">
          ...
          <h1
            className="mt-4 text-[64px] leading-[1.06] tracking-tight  font-semibold"
            style={{ color: "var(--background-text, #111827)" }}
          >
          ...
          <div className="mt-8 grid grid-cols-2 gap-x-10 gap-y-6">
            {cards.map((card, idx) => (
              <div
                key={idx}
                className="rounded-md shadow-sm px-5 py-4"
                style={{
                  backgroundColor: "var(--primary-color, #1B8C2D)",
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="flex items-baseline shrink-0">
                    <span
                      className="text-white  text-[48px] leading-none"
                      style={{ color: "var(--primary-text, #FFFFFF)" }}
                    >
                      {card.number}
                    </span>
                    <span
                      className="ml-1 text-white  text-[24px] leading-none"
                      style={{ color: "var(--primary-text, #FFFFFF)" }}
                    >
                      {card.numberSymbol}
                    </span>
                  ...
                  <div className="flex-1">
                    ...
                    <p
                      className="mt-1 text-white/95  text-[16px] leading-[1.55]"
                      style={{ color: "var(--primary-text, #FFFFFF)" }}
                    >
                      {card.body}
                    </p>
