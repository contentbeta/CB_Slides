...
const ImageSchema = z.object({
  ...
  __image_prompt__: z
    ...
    .max(90)
    .default(
      "Professional business meeting scene for roadmap presentation image",
    )
    .meta({
...
const layoutDescription =
  "A slide with a top bar, left column with numbered bullets, middle image panel, and right stacked heading with paragraph";

const Schema = z.object({
  metaMaxWords: z.number().default(18).meta({
    description:
      "Maximum number of words allowed in any prompt/description metadata fields.",
  }),
  topBar: z
    .object({
  ...
  middleImage: ImageSchema.default({
    __image_url__:
      "https://images.unsplash.com/photo-1515623959088-7617915baa1e?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    __image_prompt__:
      "Professional business meeting scene for roadmap presentation image",
  }).meta({
        ...
        <div className="flex items-center justify-between px-10 pt-6">
          <div className="flex items-center gap-4">
            ...
            >
              <path
                d="M0 1H220"
                stroke="var(--background-text, #111827)"
                strokeWidth="2"
              />
            </svg>
          </div>
        ...
        <div className="grid grid-cols-[34%_33%_33%] h-[calc(100%-64px)] mt-1">
            ...
            <ul className="flex flex-col gap-5">
              {bullets.map((b, i) => (
                <li key={i} className="flex items-center justify-between">
                  ...
                  <div
                    className="w-12 h-12 rounded-full text-white flex items-center justify-center text-[16px]  shadow-[0_12px_30px_rgba(0,0,0,0.12)]"
                    style={{
          ...
          <div className="pl-10 pr-12 pt-16">
            <div className="max-w-[560px] mx-auto">
              <h1
                className="text-[64px] leading-[0.95]  font-semibold"
                style={{ color: "var(--background-text, #111827)" }}
              >
              ...
              <p
                ...
                style={{ color: "var(--background-text, #6B7280)" }}
              >
                {slideData?.rightHeader?.paragraph ||
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore."}
              </p>
            </div>
          </div>
