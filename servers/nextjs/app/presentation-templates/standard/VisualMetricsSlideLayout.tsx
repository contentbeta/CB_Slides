...
const ImageSchema = z.object({
  ...
  __image_prompt__: z
    ...
    .min(10)
    .max(150)
    .default("Abstract light background for slide header area")
    .meta({
...
const IconSchema = z.object({
  __icon_url__: z
    ...
    .url()
    .default(
      "https://cdn.jsdelivr.net/gh/tabler/tabler-icons/icons/placeholder.svg",
    )
    .meta({
  ...
  __icon_query__: z
    ...
    .min(3)
    .max(30)
    .default("progress ring placeholder")
    .meta({
...
const layoutDescription =
  "A slide with a header bar, numeric marker, title, description, and grid of cards with headings, circular metrics, and texts";
...
const Schema = z
  .object({
    ...
    title: z
      ...
      .min(20)
      .max(68)
      .default("Our Vision And Strategy For Excellence")
      .meta({
  ...
  return (
    <>
      ...
      >
        ...
        <div className="px-12">
          <h1
            className="text-[64px] leading-[1.05] tracking-tight  font-bold mt-2"
            style={{ color: "var(--background-text, #111827)" }}
          >
            {slideData?.title}
          </h1>
          ...
          <div className="grid grid-cols-4 gap-8">
            {cards.map((card, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="rounded-xl border shadow-[0_24px_60px_rgba(0,0,0,0.08)]"
                  style={{
                    ...
                    <div className="mt-6 relative w-[180px] h-[180px]">
                      <svg viewBox="0 0 200 200" className="w-full h-full">
                        <circle
                          ...
                          r="80"
                          fill="none"
                          stroke="var(--background-text, #E5E7EB)"
                          strokeWidth="16"
                        ></circle>
                        <circle
                          cx="100"
