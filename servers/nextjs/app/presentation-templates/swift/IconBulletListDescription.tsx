...
const Schema = z
  .object({
    title: z.string().min(8).max(48).default("Key Product Features"),
    description: z
      .string()
      .min(30)
      .max(200)
    ...
    <>
      ...
      >
        ...
        <div className="px-12 pt-3">
          ...
          <p
            className="mt-3 text-[16px] max-w-[760px]"
            style={{ color: "var(--background-text, #6B7280)" }}
          >
        ...
        {/* Cyan band */}
        <div
          className="absolute left-0 right-0 bottom-20 h-[160px]"
        ...
        <div className="relative px-12 mt-8">
          <div className="grid grid-flow-col auto-cols-[260px] gap-6 justify-center">
            {features.slice(0, 4).map((f, i) => (
              <div
                key={i}
                className="rounded-[22px] shadow-[0_16px_40px_rgba(0,0,0,0.08)] overflow-hidden"
                style={{ backgroundColor: "var(--primary-color, #BFF4FF)" }}
              >
                <div className="px-6 py-5">
                  ...
                  <div
                    className="mt-4 text-[18px] font-semibold whitespace-pre-line"
