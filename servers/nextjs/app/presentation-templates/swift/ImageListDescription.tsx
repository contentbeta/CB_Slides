...
const layoutDescription =
  "List of Images with subtitle and description with one description for the entire page";
              ...
              <div key={i} className="flex flex-col items-stretch">
                ...
                <div className="h-[180px] rounded-t-md overflow-hidden">
                  <img
                    ...
                    alt={it.image.__image_prompt__}
                    className="w-full h-full object-cover"
                  />
                </div>
                {/* Cyan details panel */}
                <div
                  className="relative -mt-[1px] rounded-b-[28px] px-6 pt-6 pb-7"
