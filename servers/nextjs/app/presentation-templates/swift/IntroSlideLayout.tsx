...
const layoutDescription =
  "Intro slide with header, title, subtitle, body, image. If used for last slide, then intro card should be disabled.";
      ...
      >
        ...
        <div className="grid grid-cols-[58%_42%] gap-10 px-12 pt-4 pb-10 items-start">
          <div className="pt-4">
            ...
            <p
              className="mt-5 text-[16px] leading-[1.6] max-w-[620px] "
              style={{ color: "var(--background-text, #6B7280)" }}
            >
              {slideData?.paragraph}
            </p>
