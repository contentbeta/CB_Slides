...
const layoutDescription =
  "Swift: Our Impact in Numbers with three stacked metric cards";
...
const Schema = z
  .object({
    title: z.string().min(8).max(60).default("Our Impact in Numbers"),
    leftTitle: z
      .string()
      .min(6)
      .max(40)
    ...
    <>
      ...
      >
        ...
        <div className="px-12 pt-3 grid grid-cols-[42%_58%] gap-8 items-start">
          ...
          <div>
            <h1
              className="text-[48px] leading-[1.1] font-semibold max-w-[420px]"
            ...
            <div className="mt-8 inline-flex items-center gap-3">
              ...
              <div>
                <div
                  className="text-[20px] font-semibold whitespace-pre-line"
                  style={{ color: "var(--background-text, #111827)" }}
                >
                  {slideData?.leftTitle}
                </div>
            ...
            <p
              className="mt-5 text-[16px] leading-[1.8] max-w-[360px]"
              style={{ color: "var(--background-text, #6B7280)" }}
            >
              {slideData?.leftBody}
            </p>
          ...
          <div className="relative">
            ...
            <div
              className="absolute top-6 -right-24 w-[220px] h-[220px] rounded-full border"
            ...
            <div className="flex flex-col gap-6">
              {metrics.slice(0, 3).map((m, i) => (
                <div
                  key={i}
                  className="rounded-[18px] px-6 py-5 grid grid-cols-[38%_62%] items-start shadow-[0_16px_40px_rgba(0,0,0,0.08)]"
                ...
                >
                  ...
                  <div>
                    ...
                    <p
                      ...
                      style={{ color: "var(--primary-text, #6B7280)" }}
                    >
                      {m.description}
                    </p>
                  </div>
