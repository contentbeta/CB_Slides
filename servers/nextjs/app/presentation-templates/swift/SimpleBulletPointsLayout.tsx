...
const PointSchema = z
  ...
  .default({
    ...
    body: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.",
  });
...
const CommitmentTwoPoints: React.FC<SlideLayoutProps> = ({
  data: slideData,
}) => {
      ...
      >
        ...
        <div className="px-12 pt-4 grid grid-cols-[48%_52%] gap-10 items-start">
          ...
          <div>
            ...
            <p
              className="mt-10 text-[16px] leading-[1.8] max-w-[520px]"
              style={{ color: "var(--background-text, #6B7280)" }}
            >
              {slideData?.statement}
            </p>
