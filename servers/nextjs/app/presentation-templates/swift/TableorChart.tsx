...
const layoutDescription =
  "Swift: Generic data table with option to render a chart (bar, horizontalBar, line, pie)";
...
const chartFont = (element: HTMLElement) =>
  resolveCssValue(
    element,
    "var(--heading-font-family,Albert Sans)",
    "Albert Sans",
  ).replace(/^['"]|['"]$/g, "");
              ...
              datasets: [
                {
                  label: "value",
                  data: values,
                  backgroundColor: type === "line" ? primaryColor : colors,
    ...
    <>
      ...
      >
        ...
        <div className="px-12 pt-3">
          ...
          <p
            className="mt-3 text-[16px] max-w-[900px]"
            style={{ color: "var(--background-text, #6B7280)" }}
          >
        ...
        <div className="px-12 pt-6">
          {mode === "table" ? (
            ...
            >
              <div
                className="overflow-x-auto rounded-lg bg-white ring-1"
